...
pub struct NamedRuleWithOperations {
    ...
    #[prost(message, optional, tag = "2")]
    pub rule_with_operations: ::core::option::Option<RuleWithOperations>,
}
...
impl crate :: Resource for MutatingAdmissionPolicy { const API_VERSION : & 'static str = "admissionregistration.k8s.io/v1" ; const GROUP : & 'static str = "admissionregistration.k8s.io" ; const VERSION : & 'static str = "v1" ; const KIND : & 'static str = "MutatingAdmissionPolicy" ; const URL_PATH_SEGMENT : & 'static str = "mutatingadmissionpolicies" ; type Scope = crate :: ClusterResourceScope ; } impl crate :: Metadata for MutatingAdmissionPolicy { type Ty = crate :: apimachinery :: pkg :: apis :: meta :: v1 :: ObjectMeta ; fn metadata (& self) -> Option < & < Self as crate :: Metadata > :: Ty > { self . metadata . as_ref () } fn metadata_mut (& mut self) -> Option < & mut < Self as crate :: Metadata > :: Ty > { self . metadata . as_mut () } } impl crate :: HasSpec for MutatingAdmissionPolicy { type Spec = crate :: api :: admissionregistration :: v1 :: MutatingAdmissionPolicySpec ; fn spec (& self) -> Option < & < Self as crate :: HasSpec > :: Spec > { self . spec . as_ref () } fn spec_mut (& mut self) -> Option < & mut < Self as crate :: HasSpec > :: Spec > { self . spec . as_mut () } }

impl crate :: Resource for MutatingAdmissionPolicyBinding { const API_VERSION : & 'static str = "admissionregistration.k8s.io/v1" ; const GROUP : & 'static str = "admissionregistration.k8s.io" ; const VERSION : & 'static str = "v1" ; const KIND : & 'static str = "MutatingAdmissionPolicyBinding" ; const URL_PATH_SEGMENT : & 'static str = "mutatingadmissionpolicybindings" ; type Scope = crate :: ClusterResourceScope ; } impl crate :: Metadata for MutatingAdmissionPolicyBinding { type Ty = crate :: apimachinery :: pkg :: apis :: meta :: v1 :: ObjectMeta ; fn metadata (& self) -> Option < & < Self as crate :: Metadata > :: Ty > { self . metadata . as_ref () } fn metadata_mut (& mut self) -> Option < & mut < Self as crate :: Metadata > :: Ty > { self . metadata . as_mut () } } impl crate :: HasSpec for MutatingAdmissionPolicyBinding { type Spec = crate :: api :: admissionregistration :: v1 :: MutatingAdmissionPolicyBindingSpec ; fn spec (& self) -> Option < & < Self as crate :: HasSpec > :: Spec > { self . spec . as_ref () } fn spec_mut (& mut self) -> Option < & mut < Self as crate :: HasSpec > :: Spec > { self . spec . as_mut () } }

impl crate :: Resource for MutatingWebhookConfiguration { const API_VERSION : & 'static str = "admissionregistration.k8s.io/v1" ; const GROUP : & 'static str = "admissionregistration.k8s.io" ; const VERSION : & 'static str = "v1" ; const KIND : & 'static str = "MutatingWebhookConfiguration" ; const URL_PATH_SEGMENT : & 'static str = "mutatingwebhookconfigurations" ; type Scope = crate :: ClusterResourceScope ; } impl crate :: Metadata for MutatingWebhookConfiguration { type Ty = crate :: apimachinery :: pkg :: apis :: meta :: v1 :: ObjectMeta ; fn metadata (& self) -> Option < & < Self as crate :: Metadata > :: Ty > { self . metadata . as_ref () } fn metadata_mut (& mut self) -> Option < & mut < Self as crate :: Metadata > :: Ty > { self . metadata . as_mut () } }

impl crate :: Resource for ValidatingAdmissionPolicy { const API_VERSION : & 'static str = "admissionregistration.k8s.io/v1" ; const GROUP : & 'static str = "admissionregistration.k8s.io" ; const VERSION : & 'static str = "v1" ; const KIND : & 'static str = "ValidatingAdmissionPolicy" ; const URL_PATH_SEGMENT : & 'static str = "validatingadmissionpolicies" ; type Scope = crate :: ClusterResourceScope ; } impl crate :: Metadata for ValidatingAdmissionPolicy { type Ty = crate :: apimachinery :: pkg :: apis :: meta :: v1 :: ObjectMeta ; fn metadata (& self) -> Option < & < Self as crate :: Metadata > :: Ty > { self . metadata . as_ref () } fn metadata_mut (& mut self) -> Option < & mut < Self as crate :: Metadata > :: Ty > { self . metadata . as_mut () } } impl crate :: HasSpec for ValidatingAdmissionPolicy { type Spec = crate :: api :: admissionregistration :: v1 :: ValidatingAdmissionPolicySpec ; fn spec (& self) -> Option < & < Self as crate :: HasSpec > :: Spec > { self . spec . as_ref () } fn spec_mut (& mut self) -> Option < & mut < Self as crate :: HasSpec > :: Spec > { self . spec . as_mut () } } impl crate :: HasStatus for ValidatingAdmissionPolicy { type Status = crate :: api :: admissionregistration :: v1 :: ValidatingAdmissionPolicyStatus ; fn status (& self) -> Option < & < Self as crate :: HasStatus > :: Status > { self . status . as_ref () } fn status_mut (& mut self) -> Option < & mut < Self as crate :: HasStatus > :: Status > { self . status . as_mut () } } impl crate :: HasConditions for ValidatingAdmissionPolicy { type Condition = crate :: apimachinery :: pkg :: apis :: meta :: v1 :: Condition ; fn conditions (& self) -> Option < & [< Self as crate :: HasConditions > :: Condition] > { self . status . as_ref () . map (| s | s . conditions . as_slice ()) } fn conditions_mut (& mut self) -> Option < & mut Vec << Self as crate :: HasConditions > :: Condition >> { self . status . as_mut () . and_then (| s | Some (s . conditions . as_mut ())) } }

impl crate :: Resource for ValidatingAdmissionPolicyBinding { const API_VERSION : & 'static str = "admissionregistration.k8s.io/v1" ; const GROUP : & 'static str = "admissionregistration.k8s.io" ; const VERSION : & 'static str = "v1" ; const KIND : & 'static str = "ValidatingAdmissionPolicyBinding" ; const URL_PATH_SEGMENT : & 'static str = "validatingadmissionpolicybindings" ; type Scope = crate :: ClusterResourceScope ; } impl crate :: Metadata for ValidatingAdmissionPolicyBinding { type Ty = crate :: apimachinery :: pkg :: apis :: meta :: v1 :: ObjectMeta ; fn metadata (& self) -> Option < & < Self as crate :: Metadata > :: Ty > { self . metadata . as_ref () } fn metadata_mut (& mut self) -> Option < & mut < Self as crate :: Metadata > :: Ty > { self . metadata . as_mut () } } impl crate :: HasSpec for ValidatingAdmissionPolicyBinding { type Spec = crate :: api :: admissionregistration :: v1 :: ValidatingAdmissionPolicyBindingSpec ; fn spec (& self) -> Option < & < Self as crate :: HasSpec > :: Spec > { self . spec . as_ref () } fn spec_mut (& mut self) -> Option < & mut < Self as crate :: HasSpec > :: Spec > { self . spec . as_mut () } }

impl crate :: Resource for ValidatingWebhookConfiguration { const API_VERSION : & 'static str = "admissionregistration.k8s.io/v1" ; const GROUP : & 'static str = "admissionregistration.k8s.io" ; const VERSION : & 'static str = "v1" ; const KIND : & 'static str = "ValidatingWebhookConfiguration" ; const URL_PATH_SEGMENT : & 'static str = "validatingwebhookconfigurations" ; type Scope = crate :: ClusterResourceScope ; } impl crate :: Metadata for ValidatingWebhookConfiguration { type Ty = crate :: apimachinery :: pkg :: apis :: meta :: v1 :: ObjectMeta ; fn metadata (& self) -> Option < & < Self as crate :: Metadata > :: Ty > { self . metadata . as_ref () } fn metadata_mut (& mut self) -> Option < & mut < Self as crate :: Metadata > :: Ty > { self . metadata . as_mut () } }
