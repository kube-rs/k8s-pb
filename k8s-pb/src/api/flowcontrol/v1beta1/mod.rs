...
impl crate::HasSpec for FlowSchema {
    type Spec = crate::api::flowcontrol::v1beta1::FlowSchemaSpec;
...
impl crate::HasStatus for FlowSchema {
    type Status = crate::api::flowcontrol::v1beta1::FlowSchemaStatus;
...
impl crate::HasConditions for FlowSchema {
    type Condition = crate::api::flowcontrol::v1beta1::FlowSchemaCondition;
...
impl crate::HasSpec for PriorityLevelConfiguration {
    type Spec = crate::api::flowcontrol::v1beta1::PriorityLevelConfigurationSpec;
    fn spec(&self) -> Option<&<Self as crate::HasSpec>::Spec> {
        self.spec.as_ref()
    }
    fn spec_mut(&mut self) -> Option<&mut <Self as crate::HasSpec>::Spec> {
...
impl crate::HasStatus for PriorityLevelConfiguration {
    type Status = crate::api::flowcontrol::v1beta1::PriorityLevelConfigurationStatus;
    fn status(&self) -> Option<&<Self as crate::HasStatus>::Status> {
        self.status.as_ref()
    }
    fn status_mut(&mut self) -> Option<&mut <Self as crate::HasStatus>::Status> {
...
impl crate::HasConditions for PriorityLevelConfiguration {
    type Condition = crate::api::flowcontrol::v1beta1::PriorityLevelConfigurationCondition;
    fn conditions(&self) -> Option<&[<Self as crate::HasConditions>::Condition]> {
        self.status.as_ref().map(|s| s.conditions.as_slice())
    }
    fn conditions_mut(&mut self) -> Option<&mut Vec<<Self as crate::HasConditions>::Condition>> {
