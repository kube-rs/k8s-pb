...
pub struct PodSecurityPolicySpec {
    ...
    pub default_add_capabilities: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
    ...
    pub required_drop_capabilities: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
    ...
    pub allowed_proc_mount_types: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
...
pub struct RuntimeClassStrategyOptions {
    ...
    pub allowed_runtime_class_names: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
    ...
    pub default_runtime_class_name: ::core::option::Option<
        ::prost::alloc::string::String,
    >,
}
